        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="create-event.php" class="active">
                                ...
                                <div class="col-12">
                                    <div class="card recent-sales overflow-auto">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- Event Creation Form -->
                                            <form id="eventForm" action="event-create.php" method="POST" enctype="multipart/form-data">
                                                <div class="mb-3">
                                            ...
                                            <div id="eventDisplay" class="mt-4"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
